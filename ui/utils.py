...
class SigName:
    #axis_banner
    DI_DO_SHOW = 'DI_DO_SHOW'   #, DIOÅã¥Ü«ö¶s
    
    #major widget
    FLOW_MSG = 'FLOW_MSG'       #show flow message, send into a string
    ALARM_MSG = 'ALARM_MSG'     #show alarm message, send into a string
    PRODUCT_INFO = 'PRODUCT_INOF' #show product info,send into dictionary, ex.
    """
                                {'CT': 4.25, 
                                'ProdName': '9552A1', 
                                'MatchAngle':3.11, 
